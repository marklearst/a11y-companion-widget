...
/**
 * Creates a theme-aware drop shadow effect.
 *
 * @param isDark - Whether to use dark theme shadow
...
export { dropShadowEffect, createDropShadowEffect, createThemeShadow, DROP_SHADOW_DEFAULTS }
